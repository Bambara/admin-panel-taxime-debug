...
@Component({
  selector: 'app-approved-drivers',
  templateUrl: './approved-drivers.component.html',
  styleUrls: ['./approved-drivers.component.css']
})

export class ApprovedDriversComponent implements OnInit {
  ...
  feedData(driver, address) {
    ...
    this.driver.email = driver.email ? driver.email : '';
  ...
  updateWalletPoints() {
    ...
    rechargeWallet() {
        ...
        if (this.rechargeAmount < 100) {
            this.error('Minimum Amount is LKR 100.00');
        } else {
